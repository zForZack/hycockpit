<template>
	<div class="disciplineConstructionContnet">
		<h4 class="title">学科建设</h4>
		<div class="disciplineConstructionTable">
			<table>
				<tbody>
...
export default {
	...
	created() { // 页面未加载之前执行
		...
		this.getXuekejiansheData();
	},
	methods: {
		getXuekejiansheData() {
			var params = { name: 'xuekejianshe' };
